          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-muted-foreground">
                That's equivalent to driving approximately {Math.round(beefEmission * 4)} kilometers in an average car.
              </p>
            </motion.div>

            <div className="pt-4">
              <h3 className="text-lg font-medium mb-4">Emissions comparison by food type (kg CO₂ equivalent)</h3>
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                That's a{" "}
                <span className="font-medium">{Math.round(((beefEmission - tofuEmission) / beefEmission) * 100)}%</span>{" "}
                reduction in your food carbon footprint from this change alone.
              </p>
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>
                  Over a year, that's equivalent to planting approximately <strong>{treesEquivalent} trees</strong>
                </span>
              </div>
            </motion.div>
          </div>
